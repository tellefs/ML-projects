...
class resampling():
	...
	def Cross_Validation(self, nrk, n_epochs, t0, t1, seed, eta, minimization_method, regression_method, PolyDeg, lamb, Min, Niterations):
	...
	def NoResampling(self, n_epochs, t0, t1, seed, eta, minimization_method, regression_method, PolyDeg, lamb, Min, Niterations):
